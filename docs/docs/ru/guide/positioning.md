...
With the default CSS, Vue Select uses absolute positioning to render the
...
Vue Select will append the dropdown to the document, outside of the `.v-select`
container, and position it with Javscript.
